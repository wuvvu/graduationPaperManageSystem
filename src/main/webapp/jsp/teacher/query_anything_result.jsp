...
<div class="span10" id="right" style="width: 70%; border: 1px solid #ccc; padding: 20px;">
    <form class="form-search" method="get" action="./query_anything_result">
    ...
    <div>
        ...
        <table class="table table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>${paperSearchResult.teacherJobTitle}</td>
                </tr>
                </c:forEach>
        ...
        <div class="pagination" id="pagination">
            <span>
                ...
                <label><a href="./query_anything_result?word=${pageContext.request.getParameter("word")}">首页</a></label>
                <label><a href="./query_anything_result?word=${pageContext.request.getParameter("word")}&pageNum=${pageInfo.hasPreviousPage ? pageInfo.prePage : 1}">上一页</a></label>
                <label><a href="./query_anything_result?word=${pageContext.request.getParameter("word")}&pageNum=${pageInfo.hasNextPage ? pageInfo.nextPage : pageInfo.pages}">下一页</a></label>
                <label><a href="./query_anything_result?word=${pageContext.request.getParameter("word")}&pageNum=${pageInfo.pages}">尾页</a></label>
            </span>
        </div>
    </div>
</div>
