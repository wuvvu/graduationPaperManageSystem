...
<div class="span10" id="right" style="width: 70%; border: 1px solid #ccc; padding: 20px;">
    <c:if test="${paperSearchResults != null}">
    <div>
        ...
        <table class="table table-hover table-striped">
            ...
            <c:forEach items="${paperSearchResults}" var="paperSearchResult">
                <tr>
                    ...
                    <td><a href="./paper_evaluation?studentId=${paperSearchResult.studentId}">${paperSearchResult.paperTitle}</a></td>
        ...
        <div class="pagination" id="pagination">
            <span>
                ...
                <label><a href="./list_unevaluated_paper">首页</a></label>
                <label><a href="./list_unevaluated_paper?pageNum=${pageInfo.hasPreviousPage ? pageInfo.prePage : 1}">上一页</a></label>
                <label><a href="./list_unevaluated_paper?pageNum=${pageInfo.hasNextPage ? pageInfo.nextPage : pageInfo.pages}">下一页</a></label>
                <label><a href="./list_unevaluated_paper?pageNum=${pageInfo.pages}">尾页</a></label>
            </span>
        </div>
    </div>
    </c:if>
