    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l">
                    <a class="btn btn-primary radius" data-title="新增管理员" href="${pageContext.request.contextPath}/newAdmin/admin-add">
						<i class="Hui-iconfont"></i> 新增管理员
					</a>
                </span>
                <span class="r">共有数据：${admins.size()} 条</span>
            </div>
            <div class="mt-20">
                    ...
                    <c:forEach items="${admins}" var="admin">
                        <tr class="text-c">
                            ...
                            <td class="f-14 td-manage">
                                <a style="text-decoration:none" class="ml-5" href="./admin-modify?id=${admin.id}" title="编辑">
                                    <i class="Hui-iconfont">&#xe6df;</i>
                                </a>
                                <a style="text-decoration:none" class="ml-5" href="javascript:" onclick="deleteAdmin(${admin.id})" title="删除">
                                    <i class="Hui-iconfont">&#xe6e2;</i>
                                </a>
                            </td>
                        </tr>
