...
<article class="page-container">
    <form action="./announcement-modify.do" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return checkForm()">
        <div class="row c1">
            <label class="form-label col-xs-4 col-sm-2">标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name="title" value="${announcement.title}" id="title"/>
            </div>
        </div>
        <div class="row c1">
            <label class="form-label col-xs-4 col-sm-2">内容:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="content" cols="" rows="" class="textarea"  placeholder="" datatype="*10-100" dragonfly="true" nullmsg="内容不能为空！" id="content">${announcement.content}</textarea>
            </div>
        </div>
        <div class="row c1">
            <label class="form-label col-xs-4 col-sm-2">备注:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="remark" cols="" rows="" class="textarea"  placeholder="" datatype="*10-100" dragonfly="true" id="remark">${announcement.remark}</textarea>
            </div>
        </div>
        <div class="row cl">
