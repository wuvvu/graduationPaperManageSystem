    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l">
                    <a class="btn btn-primary radius" data-title="录入老师" href="${pageContext.request.contextPath}/newAdmin/teacher-add">
						<i class="Hui-iconfont"></i> 录入老师
					</a>
                </span>
                <span class="r">共有数据：${teachers.size()} 条</span>
            </div>
            <div class="mt-20">
                    ...
                    <c:forEach items="${teachers}" var="teacher">
                        <tr class="text-c">
                            ...
                            <td class="f-14 td-manage">
                                <a style="text-decoration:none" class="ml-5" href="./teacher-modify?id=${teacher.id}" title="编辑">
                                    <i class="Hui-iconfont">&#xe6df;</i>
                                </a>
                                <a style="text-decoration:none" class="ml-5" href="javascript:" onclick="deleteTeacher(${teacher.id})" title="删除">
                                    <i class="Hui-iconfont">&#xe6e2;</i>
                                </a>
                            </td>
                        </tr>
