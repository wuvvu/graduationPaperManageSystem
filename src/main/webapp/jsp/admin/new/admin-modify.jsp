...
<article class="page-container">
	<form action="./admin-modify.do" method="post" class="form form-horizontal" id="form-article-add">
		<input type="hidden" name="id" value="${admin.id}" />
		<div class="row c1">
			<label class="form-label col-xs-4 col-sm-2">帐号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="username" value="${admin.username}" id="username"/>
			</div>
		</div>
		<div class="row c1">
		...
		<div class="row c1">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="realName" value="${admin.realName}" id="realName"/>
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
	...
	function checkForm() {
		...
		if(username.val() === "" || password.val() === "" || realName.val() === "") {
			layer.open({
				title: '提示信息',
				content: '请完善信息'
			});
