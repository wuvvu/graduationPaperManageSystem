		...
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l">
                    ...
                    <a class="btn btn-primary radius" data-title="录入学生" href="${pageContext.request.contextPath}/newAdmin/student-add">
						<i class="Hui-iconfont"></i> 录入学生
					</a>
                </span>
					...
					<c:forEach items="${students}" var="student">
						<tr class="text-c">
							...
							<td class="f-14 td-manage">
								...
								<a style="text-decoration:none" class="ml-5" href="javascript:" onclick="deleteStudent(${student.id})" title="删除">
									<i class="Hui-iconfont">&#xe6e2;</i>
								</a>
							</td>
						</tr>
