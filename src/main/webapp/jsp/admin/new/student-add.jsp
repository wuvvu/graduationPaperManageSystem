...
<article class="page-container">
	<form action="./student-add.do" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return checkForm()">
		<div class="row c1">
		...
		<div class="row c1">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="graduationYear" id="graduationYear"/>
			</div>
		</div>
		<div class="row cl">
	...
	<div class="row cl" style="margin-left: 15%;">
		<form action="./add_student_from_csv" method="post" enctype="multipart/form-data" style="margin-top: 10px;">
			<h3>批量录入学生信息</h3>
			<a class="btn btn-success" href="${pageContext.request.contextPath}/newAdmin/downloadTemplate?type=student">下载模版</a>
