...
<nav class="navbar navbar-dark navbar-expand-md bg-primary" style="padding-top: 0;padding-bottom: 0;">
    <div class="container-fluid">
        ...
        <div class="navbar-collapse pl-5">
            <form class="form-search" method="get" action="./search_anything.do">
        ...
        <div class="span10" id="right" style="width: 70%; border: 1px solid #ccc; padding: 20px;">
            <div>
                <c:if test="${pageInfo.total != 0}">
                    <a href="./add_teacher" class="btn btn-info">新增老师</a>
                    <a href="./assign_student" class="btn btn-info">自动分配</a>
                </c:if>
                <legend style="border:none;">有[${pageInfo.total}]条相关信息</legend>
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th style="width:30%;">毕业年份</th>
                        </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${studentSearchResults}" var="studentSearchResult">
                        <tr>
                            <td>${studentSearchResult.id}</td>
                            <td>
                                <a href="./modify_student?id=${studentSearchResult.id}">
                                        ${studentSearchResult.realName}
                                </a>
                            </td>
                            <td>${studentSearchResult.subject}</td>
                            <td>${studentSearchResult.graduationYear}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
                <div class="pagination" id="pagination">
                    <span>
                        ...
                        <label><a href="./list_student_havenot_teacher">首页</a></label>
                        <label><a href="./list_student_havenot_teacher?pageNum=${pageInfo.hasPreviousPage ? pageInfo.prePage : 1}">上一页</a></label>
                        <label><a href="./list_student_havenot_teacher?pageNum=${pageInfo.hasNextPage ? pageInfo.nextPage : pageInfo.pages}">下一页</a></label>
                        <label><a href="./list_student_havenot_teacher?pageNum=${pageInfo.pages}">尾页</a></label>
                    </span>
                </div>
            </div>
        </div>
