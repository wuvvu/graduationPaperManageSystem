...
<div class="container-fluid">
    <div class="row mt-2">
        ...
        <div class="">
            <form action="./modify_teacher" method="get">
                <label>
                    <span>工号</span>
                </label>
                <label>
                    <input type="text" name="id" class="form-control" value="${teacher.id}" placeholder="输入工号" />
                </label>
            ...
            <form action="./modify_teacher.do" method="post">
                <input type="hidden" name="id" value="${teacher.id}" />
                <table>
                    <tr>
                        <td>
                        ...
                        <td>
                            <label>
                                <input type="text" name="realName"  class="form-control" value="${teacher.realName}"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="text" name="jobTitle"  class="form-control" value="${teacher.jobTitle}"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="text" name="officePhone" class="form-control"  value="${teacher.officePhone}"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="text" name="personalPhone" class="form-control"  value="${teacher.personalPhone}"/>
                            </label>
                        </td>
                    </tr>
                </table>
            ...
            <form action="./delete_teacher" method="post" style="margin-top: 10px;">
                <input type="hidden" name="id" value="${teacher.id}">
                <input type="submit" class="btn btn-danger" value="删除教师" />
            </form>
        </div>
    </div>
</div>
