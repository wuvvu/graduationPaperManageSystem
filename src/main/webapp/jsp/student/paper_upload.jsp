        ...
        <div class="span10" id="right" style="width:80%; border:1px #dededc solid; padding:20px; text-align:left;">
            <div style="border:1px #dededc solid;">
                <div style="margin-top: 10px; margin-left: 10px;">
                    初审上传
                    <form action="${pageContext.request.contextPath}/jsp/student/doUploadFile" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="time" value="first" />
                        <input type="file" name="file" accept="application/pdf" ${firstUploadDisabled} />
                        <input type="submit" class="btn btn-primary" ${firstUploadDisabled} />
                    </form>
                    ${firstUploadMessage}
                </div>
            </div>
            ...
            <div style="border:1px #dededc solid;margin-top: 20px;">
                <div style="margin-top: 10px; margin-left: 10px;">
                    ...
                    <form action="${pageContext.request.contextPath}/jsp/student/doUploadFile" method="post" enctype="multipart/form-data">
                        ...
                        <input type="file" name="file" accept="application/pdf" ${finalUploadDisabled} />
                        <input type="submit" class="btn btn-primary" ${finalUploadDisabled} />
                    </form>
                    ${finalUploadMessage}
                </div>
            </div>
